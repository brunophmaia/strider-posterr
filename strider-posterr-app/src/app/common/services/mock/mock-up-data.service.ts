...
export class MockUpDataService {
  ...
  constructor(private localStorage: LocalStorageService) {
    this.localStorage.checkMockData(users, usersFollowing, posts);
  }

  cleanAndMockData(){
    this.localStorage.mockData(users, usersFollowing, posts);
  }

  cleanData(){
    this.localStorage.mockData([], [], []);
  }
}

const users: Array<User> = [{ "username": "brunophmaia", "joinedDate": new Date("2022-09-19T03:00:00.000Z") },
                                   { "username": "strider", "joinedDate": new Date("2022-09-20T03:00:00.000Z") },
...
const usersFollowing: Array<UserFollowing> = [{"username":"strider","userFollowing":"brunophmaia"},
                                                     {"username":"brunophmaia","userFollowing":"strider"},
...
const posts: Array<Post> = [{
                                   ...
                                   },
                                   {
                                    ...
                                    "id":"1664134848747-strider"
                                   },
                                   {
                                    "author":"brunophmaia",
                                    "idRepost":"1664134848747-strider",
